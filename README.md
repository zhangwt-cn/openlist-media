...
```html
<script src="https://cdn.jsdelivr.net/gh/zhangwt-cn/openlist-media@v0.1.3/openlist-media.js" defer></script>
```
...
2. 回到**整理**页：目录默认取当前 OpenList 浏览路径，也可「浏览…」选择；「整理到目录」可选填本次的输出目录（整理单个剧集文件夹时选它的上级目录即可避免套娃，留空 = 就地整理/按设置）→ **扫描并生成整理方案**
...
MIT License · 与 OpenListTeam 无隶属关系 · v0.1.3
